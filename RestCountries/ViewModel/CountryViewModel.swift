...
struct CountryViewModel {
    ...
    init(country: Country) {
        ...
        self.flagImageUrl = String.init(format: Common.getCountryFlagInPng, arguments: [country.alpha2Code])//country.flag - to avoid problems with loading/rendering SVG file
        ...
        self.details.append(CountryDetailViewModel.init(name: "demonym", value: country.demonym))
        self.details.append(CountryDetailViewModel.init(name: "area", value: "\(country.area ?? 0)km²"))
